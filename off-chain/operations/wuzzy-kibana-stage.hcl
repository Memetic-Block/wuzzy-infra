  ...
  group "wuzzy-kibana-stage-group" {
    ...
    task "wuzzy-kibana-stage-task" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.middlewares.wuzzy-kibana-stage-ipwhitelist.ipwhitelist.sourcerange=24.177.3.83",
          ...
          "traefik.http.routers.wuzzy-kibana-stage.middlewares=wuzzy-kibana-stage-ipwhitelist@consulcatalog,wuzzy-kibana-stage-corsheaders@consulcatalog"
        ]
      }
    }
  }
